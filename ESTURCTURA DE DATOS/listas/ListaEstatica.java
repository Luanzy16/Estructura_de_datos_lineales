...
public class ListaEstatica{
    private Object[] dato = new Object[10]; 
    private int[] siguiente = new int[10];
    private int size = 0;
   

    //metodo para agreagar al final
    public void agregarFinalE(Object valor){
        if(size == 0){
            dato[0] = valor;
            siguiente[0] = 1;
            size++;
    ...
    public Object getDatoE(int index){
        int i = 0; 
        int contador = 0;
    ...
    public int indexDeE(Object valor){
        int i = 0;
    ...
    public Object borrarFinalE(){
        int i=0;
        Object valor = dato[size];
        int temporal = siguiente[i];
